...
`,
		...
		<div class="page page-index">
			<div class="card transparent">
				...
				<div class="columns-view">
					...
					<div class="column column-1 shadow grid">
						<h4 class="center captions">Multisig</h4>
						<div class="wide-buttons captions">
							<a class="wide-button color-blue" data-href="/multisig/">Proposals</a>
							<a class="wide-button color-blue" data-href="/multisig/create/">New proposal</a>
						</div>
					</div>
				</div>
			</div>
	...
	pm_yes:'Yes',
	pm_no:'No',
	pm_options_n:'{n} options',
	pm_closes:'Closes',
	pm_closed_lc:'closed',
	pm_open_ended:'open-ended',
	pm_soon:'very soon',
	pm_in_hours:'in {n}h',
	pm_in_days:'in {n}d',
	pm_submit:'Submit',
	...
	header_lock_wallet:'Lock wallet',
	header_add_account:'Add account',
	header_switch_account:'Switch account',
	header_logout:'Logout',
	index_social_capital_adaptive_caption:'Capital (viz):',
	index_balance_adaptive_caption:'Balance (viz):',
	index_frozen_markets_title:'Oracle insurance collateral',
	index_frozen_pool_title:'Locked in the lazy liquidity pool',
	index_frozen_liquidity_title:'Locked as market liquidity',
	index_frozen_bets_title:'Locked in open bets',
	index_frozen_leverage_title:'Locked as leverage collateral',
	...
	validator_props_captions:{
		...
		pm_min_bet:'Minimum bet amount (VIZ)',
		...
		pm_settle_rows_per_block:'Settlement rows per block',
		committee_votes_per_request:'Maximum committee votes per request',
		committee_vote_min_vesting:'Minimum effective vesting (VIZ) for a committee vote',
		pm_dispute_votes_per_market:'Maximum dispute votes per market',
		pm_dispute_vote_min_vesting:'Minimum effective vesting (VIZ) for a dispute vote',
	...
	preset_view_multisig_title:'Multisig',
	ms_create_button:'New proposal',
	ms_list_title:'Proposals (yours &amp; awaiting your signature)',
	ms_create_title:'New proposal',
	ms_f_title:'Title (unique per author)',
	ms_f_memo:'Memo (optional)',
	ms_f_expiration:'Expiration',
	...
	ms_pw_all:'all',
	ms_op_validator_update:'Validator: announce / update',
	ms_op_account_create:'Create account',
	ms_op_account_price:'Put account on sale',
	ms_op_subaccount_price:'Put subaccounts on sale',
	ms_vu_url:'Validator URL',
	ms_vu_key:'Block signing key (empty = deactivate)',
	ms_ac_name:'New account name',
	ms_ac_key:'Public key (master/active/regular/memo)',
	ms_ac_fee:'Fee, VIZ',
	ms_ac_delegation:'Delegation, SHARES (optional)',
	ms_sap_seller:'Seller (payment recipient)',
	ms_sap_price:'Price, VIZ',
	ms_onsale:'Status',
	...
	ms_t_memo:'Memo (optional)',
	ms_au_account:'Account to update',
	ms_au_hint:'Sets the active authority (keys/accounts and threshold that govern the account). Load current values, edit, then propose.',
	ms_au_threshold:'Weight threshold',
	ms_au_auths:'Authorities (account name or VIZ public key + weight)',
	ms_au_add_auth:'+ add',
	ms_au_load:'Load current',
	ms_create_submit:'Create proposal',
	ms_none:'No proposals.',
	ms_author:'Author',
	ms_expires:'Expires',
	ms_expired:'expired',
	ms_open:'Open',
	ms_ops:'Operations',
	ms_approvals:'Approvals',
	ms_needed:'still needed',
	ms_key_approvals:'Key approvals',
	ms_approve_account:'Approve with my account',
	ms_approve_key_title:'Approve with a separate private key',
	ms_key_wif_ph:'Private key (WIF)',
	ms_approve_key_btn:'Sign with this key',
	ms_revoke:'Revoke my approval',
	ms_delete:'Delete / veto',
	ms_delete_confirm:'Delete this proposal? This cannot be undone.',
	ms_create_fill:'Fill in all required fields.',
	ms_create_ok:'Proposal created.',
	ms_sign_ok:'Signature broadcast.',
	ms_revoke_ok:'Approval revoked.',
	ms_delete_ok:'Proposal deleted.',
	ms_bad_wif:'Invalid private key.',
	ms_err:'Error',
