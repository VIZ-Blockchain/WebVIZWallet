...
**<https://viz-blockchain.github.io/WebVIZWallet/>** (см. [docs/ru/build.md](docs/ru/build.md)).
...
Подробное описание — в каталоге [docs/ru/](docs/ru/):

- [Архитектура](docs/ru/architecture.md) — устройство, разделение клиент/сервер, карта файлов.
- [Установка и развёртывание](docs/ru/setup.md) — nginx, PHP, MySQL, конфигурация.
- [PHP-бэкенд](docs/ru/backend.md) — роутинг, поиск/сортировка витрин, админка, cron, схема БД.
- [Клиент](docs/ru/frontend.md) — приложение, представления, иконки, шрифты.
- [Локализация](docs/ru/localization.md) — система `ltmp_*` (ru/en/zh).
- [Сборка](docs/ru/build.md) — автономная версия и публикация в GitHub Pages.
