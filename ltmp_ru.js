...
`,
	...
	pm_pool_emergency_confirm:'Вывести экстренно сейчас? Штраф применяется только к начисленным наградам (никогда к телу депозита). Если в пуле нет свободного баланса, выплата встаёт в очередь и платится по мере возврата капитала.',
	pm_pool_pending:'Ожидают вывода',
	pm_pool_queue_note:'Если сейчас в пуле нет свободного баланса, вывод встаёт в очередь и выплачивается частями по мере возврата капитала из рынков — пул никогда не выдаёт больше, чем держит.',
	pm_pool_emergency_warn:'Экстренный выход до разблокировки. Штраф — только на начисленные награды, никогда на тело депозита. Укажите доли для вывода (0 = всё).',
	pm_pool_queued_notice:'У вас заявка на вывод',
	pm_pool_queued_tail:'выплачивается автоматически (FIFO) по мере возврата капитала в пул.',
	pm_outcome:'Исход',
	pm_payout:'Выплата',
	...
	pm_yes:'Да',
	pm_no:'Нет',
	pm_options_n:'вариантов: {n}',
	pm_closes:'Закрытие',
	pm_closed_lc:'закрыто',
	pm_open_ended:'без срока',
	pm_soon:'совсем скоро',
	pm_in_hours:'через {n} ч',
	pm_in_days:'через {n} дн',
	pm_submit:'Отправить',
	...
	preset_view_pm:`
		...
		<div class="page page-pool">
			<div class="card">
				...
				<div class="addon captions">
					<h3>Подсказка</h3>
					<p>Внесите VIZ в общий пул «ленивой» ликвидности. Ваш капитал обеспечивает маркет-мейкинг на рынках прогнозов и приносит долю торговых комиссий и процентов по кредитному плечу.</p>
					<p>Награды начисляются непрерывно и увеличивают стоимость вашей позиции. Депозит блокируется на фиксированный срок; плановый вывод доступен после разблокировки.</p>
					<p>Экстренный вывод до разблокировки вернёт средства сразу, но штраф применяется к начисленным наградам &mdash; никогда к телу депозита. Капитал в пуле несёт риск маркет-мейкинга; доходность не гарантирована.</p>
				</div>
	...
	header_lock_wallet:'Заблокировать кошелёк',
	header_add_account:'Добавить аккаунт',
	header_switch_account:'Переключить аккаунт',
	header_logout:'Выйти',
	index_social_capital_adaptive_caption:'Капитал (viz):',
	index_balance_adaptive_caption:'Баланс (viz):',
	index_frozen_markets_title:'Страховой залог оракула',
	index_frozen_pool_title:'Заморожено в lazy-пуле ликвидности',
	index_frozen_liquidity_title:'Заморожено в ликвидности рынков',
	index_frozen_bets_title:'Заморожено в открытых ставках',
	index_frozen_leverage_title:'Заморожено в плече (залог)',
	...
	validator_props_captions:{
		...
		/* Рынки предсказаний (HF14) */
		pm_oracle_registration_fee:'Комиссия за регистрацию оракула',
		pm_min_oracle_insurance:'Минимальный страховой депозит оракула',
		pm_market_creation_fee:'Комиссия за создание рынка предсказаний',
		pm_min_liquidity:'Минимальная начальная ликвидность рынка',
		pm_max_outcomes:'Максимальное число исходов на рынке',
		pm_max_market_duration:'Максимальная длительность рынка (секунды)',
		pm_max_oracle_fee_percent:'Максимальная комиссия оракула (процент)',
		pm_oracle_accept_window_sec:'Окно принятия рынка оракулом (секунды)',
		pm_listing_min_coverage_percent:'Минимальное покрытие для листинга рынка (процент)',
		pm_betting_min_coverage_percent:'Минимальное покрытие для продолжения ставок (процент)',
		pm_default_time_penalty_percent:'Штраф по времени по умолчанию (процент)',
		pm_max_time_penalty:'Максимальный штраф по времени (сырые единицы)',
		pm_dispute_fee:'Комиссия за открытие спора',
		pm_dispute_grace_sec:'Льготный период спора до резолва (секунды)',
		pm_oracle_dispute_response_sec:'Окно ответа оракула в споре (секунды)',
		pm_dispute_auto_close_sec:'Таймаут авто-закрытия спора (секунды)',
		pm_dispute_vote_period_sec:'Период голосования в споре (секунды)',
		pm_dispute_approve_min_percent:'Минимальная доля для одобрения спора (процент)',
		pm_oracle_penalty_percent:'Штраф оракулу за проигранный спор (процент)',
		pm_no_contest_penalty_percent:'Штраф за отменённый / no-contest рынок (процент)',
		pm_dispute_reward_multiplier:'Множитель вознаграждения за спор (базисные пункты)',
		pm_batch_epoch_blocks:'Длина батч-эпохи (блоки)',
		pm_reveal_window_blocks:'Окно раскрытия commit-reveal (блоки)',
		pm_commit_no_reveal_penalty_percent:'Штраф за коммит без раскрытия (процент)',
		pm_min_batch_bet:'Минимальная сумма батч-ставки',
		pm_min_bet:'Минимальная ставка (VIZ)',
		pm_commit_reveal_enabled:'Включить ставки commit-reveal (true/false)',
		pm_processing_cap_per_block:'Максимум PM-операций, обрабатываемых за блок',
		pm_settle_rows_per_block:'Строк сеттла за блок',
		committee_votes_per_request:'Максимум голосов комитета на одну заявку',
		committee_vote_min_vesting:'Минимальный эффективный вестинг (VIZ) для голоса в комитете',
		pm_dispute_votes_per_market:'Максимум голосов спора на рынок',
		pm_dispute_vote_min_vesting:'Минимальный эффективный вестинг (VIZ) для голоса в споре',
		pm_lazy_pool_enabled:'Включить ленивый пул ликвидности (true/false)',
		pm_lazy_alloc_percent:'Аллокация ленивого пула на рынок (процент)',
		pm_lazy_max_total_alloc_percent:'Максимальная суммарная ленивая аллокация (процент)',
		pm_lazy_lock_sec:'Период блокировки ленивой аллокации (секунды)',
		pm_lazy_recall_step_percent:'Шаг отзыва ленивой аллокации (процент)',
		pm_lazy_emergency_penalty_percent:'Штраф за экстренный отзыв ленивой аллокации (процент)',
		pm_lazy_min_liquidity_fee_percent:'Минимальная комиссия ликвидности рынка для субсидии ленивого пула (процент)',
		pm_leverage_enabled:'Включить торговлю с плечом (true/false)',
		pm_leverage_fund_percent:'Доля свободного баланса под займы с плечом (целый процент)',
		pm_leverage_max_per_position_bp:'Максимальная экспозиция плеча на позицию (процент)',
		pm_leverage_pool_profit_percent:'Доля прибыли пула плеча (целый процент)',
		pm_leverage_safety_margin_percent:'Запас прочности плеча при открытии (целый процент)',
		pm_leverage_max_slippage_percent:'Максимальное проскальзывание плеча (целый процент)',
		pm_leverage_min_market_liquidity:'Минимальная ликвидность рынка для плеча',
		pm_leverage_max_position_ratio_percent:'Максимальное отношение позиции с плечом (целый процент)',
		pm_leverage_expiration_buffer_sec:'Буфер до истечения плеча (секунды)',
		pm_leverage_m_factor_percent:'Маржинальный фактор M плеча (целый процент)',
		pm_leverage_funding_rate_ppm_per_day:'Ставка фандинга плеча (ppm в сутки, 1000000 = 100%)',
		pm_conversion_profit_cost_percent:'Стоимость прибыли при конвертации позиции (целый процент)',
		pm_closed_market_retention_sec:'Хранение данных закрытого рынка (секунды)',
	},
	...
	ms_op_delegate:'Делегировать доли (vesting)',
	ms_op_award:'Награда (award, энергией)',
	ms_op_validator_vote:'Голос за валидатора',
	ms_op_validator_proxy:'Прокси голосов за валидаторов',
	ms_op_reward_sharing:'Доля награды валидатора',
	ms_op_committee_create:'Комитет: создать заявку',
	ms_op_committee_vote:'Комитет: голос по заявке',
	ms_op_pool_deposit:'Пул ликвидности: депозит',
	ms_op_pool_withdraw:'Пул ликвидности: вывод',
	ms_actor:'Аккаунт-инициатор (мультисиг)',
	ms_dg_delegatee:'Кому делегируем',
	ms_dg_shares:'Доли (SHARES, 0 = снять делегирование)',
	ms_aw_receiver:'Получатель',
	ms_aw_energy:'Энергия, %',
	ms_vv_validator:'Валидатор',
	ms_vv_approve:'Голос',
	ms_vv_yes:'Поддержать',
	ms_vv_no:'Снять голос',
	ms_vp_proxy:'Аккаунт-прокси (пусто = сбросить)',
	ms_rs_rate:'Доля награды, %',
	ms_cc_url:'URL (описание)',
	ms_cc_worker:'Исполнитель (аккаунт выплаты)',
	ms_cc_min:'Сумма мин., VIZ',
	ms_cc_max:'Сумма макс., VIZ',
	ms_cc_duration:'Срок, дней (5–30)',
	ms_cv_reqid:'ID заявки',
	ms_cv_percent:'Голос, % (−100…100)',
	ms_pd_amount:'Сумма, VIZ',
	ms_pw_shares:'Доли (0 = всё)',
	ms_pw_emergency:'Тип вывода',
	ms_pw_planned:'Плановый',
	ms_pw_emg:'Экстренный (штраф на награды)',
	ms_pw_all:'всё',
	ms_op_validator_update:'Валидатор: объявить / обновить',
	ms_op_account_create:'Создать аккаунт',
	ms_op_account_price:'Выставить аккаунт на продажу',
	ms_op_subaccount_price:'Выставить субаккаунты на продажу',
	ms_vu_url:'URL валидатора',
	ms_vu_key:'Ключ подписи блоков (пусто = деактивировать)',
	ms_ac_name:'Имя нового аккаунта',
	ms_ac_key:'Публичный ключ (master/active/regular/memo)',
	ms_ac_fee:'Комиссия, VIZ',
	ms_ac_delegation:'Делегирование, SHARES (опц.)',
	ms_sap_seller:'Продавец (получатель оплаты)',
	ms_sap_price:'Цена, VIZ',
	ms_onsale:'Статус',
